...
export default function AdminCommercePage(){
  ...
  return <main className="admin-shell">
    <aside className="admin-sidebar"><Link className="wordmark" href="/"><span className="wordmark-glyph">EN</span><span>ENAcademy</span></Link><span className="admin-badge">ADMIN</span><nav><Link href="/admin">⌂ {t('admin.overview')}</Link><Link className="active" href="/admin/commerce">▤ {t('commerce.commerce')}</Link><Link href="/dashboard">↗ {t('admin.studentView')}</Link></nav><button className="admin-signout" onClick={signOut}>{t('admin.signOut')} ↗</button></aside>
